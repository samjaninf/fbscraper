					...
					<div class="footer-content">
						<form role="form" method="post" id="footer-form" action="<?php echo site_url("home/email_contact"); ?>">
							...
							<div class="form-group has-feedback">
								...
								<div class="row">
									<div class="col-xs-12 col-md-4"><?php echo $captcha['image']; ?></div>
									<div class="col-xs-12 col-md-8">
										<input type="number" class="form-control" step="1" required id="captcha" <?php echo set_value("captcha"); ?> placeholder="<?php echo $this->lang->line("captcha");?>" name="captcha">
									</div>
									<div class="col-xs-12">
										<span class="red">
											<?php 
