...
<section class="content-header">
	<h1 class = 'text-info'><?php echo $this->lang->line("Event Search");?></h1>
</section>
	...
	<div class="row" >
		<div class="col-xs-12">
			<div class="grid_container" style="width:100%; min-height:760px;">
				...
				url="<?php echo base_url()."event_search/event_search_data"; ?>" 
				...
				>
					...
					<thead>
						<tr>
							...
							<th field="name" sortable="true"><?php echo $this->lang->line('event name'); ?></th>
							<th field="attending_count" sortable="true"><?php echo $this->lang->line('attending'); ?></th>
							<th field="interested_count" sortable="true"><?php echo $this->lang->line('interested'); ?></th>
							<th field="maybe_count" sortable="true"><?php echo $this->lang->line('may be attend'); ?></th>
							<th field="noreply_count" sortable="true"><?php echo $this->lang->line('no reply'); ?></th>
							<th field="declined_count" sortable="true"><?php echo $this->lang->line('declined'); ?></th>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<?php }else { if($validatity == 'no'){ ?>
						<div class="alert alert-danger text-center">
							<b>Your validatity has been expired, please <?php echo $fb_login_button; ?></b>
						</div>
						<?php }else { ?>
			...
			<form class="form-inline" style="margin-top:20px">
				...
				<div class="form-group">
					<input id="name" name="name" class="form-control" size="20" placeholder="<?php echo $this->lang->line('event name');?>">
				</div>  
	...
	<div class="modal-dialog modal-lg" style="width:100%;">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-binoculars"></i> <?php echo $this->lang->line("Event Search");?></h4>
			</div><br/>
			...
			<div id="new_search_view_body" class="modal-body">
				...
				<div class="row"> 
					...
					<div class="col-xs-12" class="text-center">
						<h3><?php echo $this->lang->line("Total Event Search"); ?> : <span id="progress_msg_text"></span></h3>
					</div>   
...
<script>
	...
	$(".download").click(function(){
		...
		var url = "<?php echo site_url('event_search/event_search_download');?>";
	...
	$(".delete").click(function(){
		...
		if(result)
		{
			...
			var base_url="<?php echo base_url(); ?>";		
			var url = "<?php echo site_url('event_search/event_search_delete');?>";
	        var rows = $j("#tt").datagrid("getSelections");
	        var info=JSON.stringify(rows); 
	...
	function get_bulk_progress()
	{
		var base_url="<?php echo base_url(); ?>";			
		$.ajax({
			url:base_url+'event_search/bulk_event_search_progress_count',
			type:'POST',
			dataType:'json',
			success:function(response){
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			$.ajax({
				url:base_url+'event_search/event_search_action',
				type:'POST',
				data:{keyword:keyword,limit:limit},
				success:function(response){
					$("#success_msg").html('<center><h3 style="color:olive;"><?php echo $this->lang->line("completed"); ?></h3></center>');
					$("#download_div").html('<center><a style="margin: 0px auto;" href="<?php echo base_url()."download/event_search/event_search_".$this->user_id."_".$this->session->userdata("download_id").".csv"; ?>" target="_blank" class="btn btn-lg btn-warning"><i class="fa fa-cloud-download"></i> <b><?php echo $this->lang->line('download'); ?></b></a></center>');
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
							...
							<?php 
								...
								echo "<a href='".base_url()."download/event_search/event_search_".$this->user_id."_".$download_id.".csv"."'". "title='Download' class='btn btn-warning btn-lg' style='width:200px;'><i class='fa fa-cloud-download' style='color:white'></i>  ".$this->lang->line('download')."</a>";							
							?>
							</div>		
